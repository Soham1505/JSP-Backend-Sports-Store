...
--
-- Host: localhost    Database: sportsstore
-- ------------------------------------------------------
...
CREATE TABLE `billing` (
  ...
  CONSTRAINT `fk_customerId` FOREIGN KEY (`customerId`) REFERENCES `customers` (`id`) ON DELETE CASCADE,
...
INSERT INTO `daily_sales` VALUES ('2025-01-29',3553.00,4),('2025-01-30',13500.00,2),('2025-02-07',22500.00,1),('2025-02-10',31200.00,9),('2025-02-11',3500.00,5),('2025-03-25',1050.00,1);
...
INSERT INTO `users` VALUES (14,'soham','soham'),(15,'admin','admin');
...
-- Dump completed on 2025-03-25 19:52:31
